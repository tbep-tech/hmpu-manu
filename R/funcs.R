...
alluvout2 <- function(datin, fluccs, mrg, height = 1000, width = 800, fontSize = 13){
  ...
  out <- sankeyNetwork(Links = sumdat, Nodes = nodes,
                       ...
                       Value = "value", NodeID = "name", height = height, width = width,
                       sinksRight=FALSE, units = 'acres', nodeWidth=50, fontSize=fontSize, nodePadding=10,
                       margin = mrgs)
