...
The geospatial analysis that produced a map of the remaining opportunity areas provided an areal estimate of where practitioners could target future restoration projects (@fig-oppmap). Native lands categorized as existing conservation native, proposed conservation native, or reservation native totaled.  Similarly, restorable lands categorized as existing conservation restorable, proposed conservation restorable, or reservation restorable totalled.  Understandably, most of the native and restorable lands occurred in undeveloped areas of the watershed, particularly in the north and southwest. Existing conservation lands (existing conservations native, existing conservation restorable) totalled and proposed conservation lands (proposed conservation native, proposed conservation restorable).  Areas in the coastal stratum (the MLLW to 5-foot contour) included of reservation native habitats and ha of reservation restorable habitats. 

Combining the restorable lands in @fig-oppmap with the coastal stratum, soils, and salinity data provided a spatial summary of the restoration potential grouped by habitat type (@fig-restmap).  The restortation potential
