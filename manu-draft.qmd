...
```{r}
#| tbl-cap: Summary of habitat restoration opportunities in the Tampa Bay watershed.  Summaries are based on 2017 land use data, 2018 subtidal data, best estimates for habitat types not in existing GIS layers (e.g., living shoreline), and current extent of existing and proposed conservation lands.
currtab
```
